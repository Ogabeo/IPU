...
from .models import User, UserJob, UserScienceTip, UserDegree, UserResetPassword
...
class UserRegisterView(View):
    ...
    def get(self, request):
        ...
        science_tips = UserScienceTip.objects.all()
        degrees = UserDegree.objects.all()

        context = {
            'form':form,
            'jobs':jobs,
            'science_tips':science_tips,
            'degrees':degrees,
        }
